...
格式参考
```
{: id="20201130150319-4qzm51e"}

### 应用名
{: id="20201130150319-ig7ikv9"}

xxxx
{: id="20201130150319-a8vyjns"}

### 说明
{: id="20201130150319-56kdy4o"}

功能说明
{: id="20201130150319-a4trqum"}

### 构建步骤
{: id="20201130150319-p1cdilb"}

构建步骤说明
{: id="20201130150319-ty2zvi6"}
...
参考：
```
{: id="20201130150319-v6cy3kp"}

### 0.0.1（版本号，必填）
{: id="20201130150319-5mwkibh"}

release-date: 2020-01-01（发布日期，必填）
**新增**
{: id="20201130150319-lkhfzos"}

1. {: id="20201130150319-u1xm5zw"}xxx厂商ASR接口
2. {: id="20201130150319-79iedhy"}xxx统计报表
   **修改**
3. {: id="20201130150319-x9cyhx7"}xxx处理流程
   **删除**
4. {: id="20201130150319-a7gkszc"}xxx接口
{: id="20201130150319-xnqs800"}
...
```
{: id="20201130150319-xfip5d4"}

<?xml version="1.0" encoding="UTF-8"?>

{: id="20201130150319-i1te9zy"}

<configuration  scan="true" scanPeriod="60 seconds" debug="true">
	<property name="APP_NAME" value="xxx" />

{: id="20201130150319-c8t9lv2"}
...
```
{: id="20201130150319-f2j7ocq"}

</configuration>
```

{: id="20201130150319-1g7q2mo"}

### 作为统计项的日志
{: id="20201130150319-hofshjp"}

业务统计将通过分析Elasticsearch的日志实现。所有后期进行统计的日志加一个统一的关键字，便于过滤。
{: id="20201130150319-m74abyl"}

作为统计项的日志格式参考：
{: id="20201130150319-l8d4086"}

#### 正常业务日志
{: id="20201130150319-wii7zlf"}
...
|   |   |   |
{: id="20201130150319-wgkyl2v"}

#### 异常业务日志
{: id="20201130150319-qutxr7e"}
...
{: id="20201130150319-xyuzph4"}

```

```
{: id="20201130150319-4jxzmdz"}
